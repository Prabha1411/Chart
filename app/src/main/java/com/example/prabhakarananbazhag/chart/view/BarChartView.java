...
//            Xaxis.add(datas);
//            //Xaxis.addAll((Collection) Xaxis.get());
//            ArrayList Yaxis=new ArrayList();
//            Yaxis.add(datas);
//           // Yaxis.addAll((Collection) datas.get("Yaxis"));
//            //.............XFormat Checking.............
//            Point xcheck= (Point) Xaxis.get(0);
//            int check=xFormat(String.valueOf(xcheck));
//            int xc=0;
//            String xplot=new String();
//            switch (check)
//            {
//                case 0:
//                    xplot= String.valueOf(xString(Xaxis,canvas,length,breadth));
//                    xc=1;
//                    break;
//                default:
//                    Log.i("scale","Integer");
//                    xplot= String.valueOf(xNumber(Xaxis,canvas,length,breadth));
//                    xc=2;
//                    break;
//            }
//            //.............YFormat Checking.............
//            Point ycheck=(Point) Yaxis.get(0);
//            int checky=yFormat(String.valueOf(ycheck));
//            int yc=0;
//            String yplot=new String();
//            switch (checky)
//            {
//                case 0:
//                    yplot= String.valueOf(yString(Yaxis,canvas,length,breadth));
//                    yc=1;
//                    break;
//                default:
//                    Log.i("scale","y...Integer");
//                    yplot= String.valueOf(yNumber(Yaxis,canvas,length,breadth));
//                    yc=2;
//                    break;
//            }
//            //.........PLOTTING..............
...
//        }
//    }
//    private void plot(ArrayList xaxis, ArrayList yaxis, String xplot, String yplot, Canvas canvas, int xc, int yc, String Barwidth, ArrayList Colours, int length) {
//        int s=xaxis.size();
//        int width=Integer.parseInt(Barwidth)/2;
//        if((xc==1)&&(yc==1)) { //X and Y String
//            for (int j = 0; j < s; j++) {
//                String val1= String.valueOf(xaxis.get(j));
//                String val2=(String.valueOf( yaxis.get(j)));
//                Object xcc = (val1);
//                Object ycc = (val2);
...
//                    int distance;
//                    Object temp1=((float)integer_part);
//                    Object temp2;
//                    int v=s-1;
//                    if(j==v) {
//                        temp2=((float)integer_part-1);
//                    }
//                    else {
//                        temp2=((float)integer_part+1);
//                    }
...
//                String val1=(String) xaxis.get(j);
//                String tc=Float.parseFloat(val1);
//                //Check wheather the number is Integer or Float..........
//                if((xplot.contains(tc))){
//                    float new_value=  Float.parseFloat((String)xaxis.get(j));
//                    String val2= (String) yaxis.get(j);
//                    Object xcc =  (new_value);
//                    Object ycc =  (val2);
//                    //canvas.drawCircle((int) xcc, (int) ycc, 5, coordinate);
//                    Bar.setColor(Color.parseColor((String) Colours.get(j)));
//                    canvas.drawRect((int) xcc-width,(int)ycc,(int) xcc+width,length-100,Bar);
...
//                    //...........Distance between two Elements.................
//                    int distance_x;
//                    Object temp1=((float)integer_part_x);
//                    Log.i("S", String.valueOf(temp1));
//                    Object temp2;
//                    int v=s-1;
//                    if(j==v) {
//                        temp2=((float)integer_part_x-1);
//                    }
//                    else {
//                        temp2=((float)integer_part_x+1);
//                    }
...
//                    //...........Distance between two Elements.................
//                    int distance_y;
//                    Object temp1_y=((float)integer_part);
//                    Object temp2_y;
//                    int v_y=s-1;
//                    if(j==v_y) {
//                        temp2_y=((float)integer_part-1);
//                    }
//                    else {
//                        temp2_y=((float)integer_part+1);
//                    }
